...
async def get_ticket_by_id(ticket_id: str) -> str:
    ...
    Args:
        ticket_id: ID del ticket da recuperare
        
    Returns:
        str: JSON con i dettagli del ticket
    """
    try:
        collection = get_collection()
        
        # Cerca il ticket per ID
        ...
        return json.dumps(ticket_details, ensure_ascii=False, indent=2)
